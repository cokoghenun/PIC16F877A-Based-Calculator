...
# 13 "C:/Program Files/Microchip/MPLABX/v5.50/packs/Microchip/PIC16Fxxx_DFP/1.2.33/xc8\\pic\\include\\pic.h" 3
...
void InitLCD(void)
{
    ...
    _delay((unsigned long)((6)*(20000000/4000.0)));
...
void disp_num(int numb)
{
    ...
    if( TenthDigit != 0)
        WriteDataToLCD(TenthDigit+0x30);

    UnitDigit = numb - TenthDigit*10;

    WriteDataToLCD(UnitDigit+0x30);
}
